...
if __name__ == '__main__':
    ...
    #--------------------------------------------------------------------------------------------------------------------------------------
    LogErrDebug('Message', f'Программы установки и обновления Pytnob: {_version} ; от {_verdate} ; Автор {_author} ; ',
                os.path.basename(__file__))
    LogErrDebug('Message',
                f'Установлен Python ver.{platform.python_version()} ; {platform.python_build()[1]} ; {platform.python_compiler()}',
                os.path.basename(__file__))
    #------------------------------------------------------------------------
